...
docker run --rm -p 8545:8545 -v $(pwd)/snapshots/avs-and-eigenlayer-deployed-anvil-state.json:/avs-and-eigenlayer-deployed-anvil-state.json --entrypoint anvil ghcr.io/foundry-rs/foundry:nightly-de33b6af53005037b463318d2628b5cfcaf39916 --load-state /avs-and-eigenlayer-deployed-anvil-state.json --host 0.0.0.0 &
ANVIL_PID=$!
sleep 2
