...
type API struct {
	...
	EndPoints *API_End_Points `protobuf:"bytes,1,opt,name=EndPoints,proto3" json:"EndPoints,omitempty"`
}
...
func (x *API) GetEndPoints() *API_End_Points {
	if x != nil {
		return x.EndPoints
	}
	return nil
...
type API_End_Points struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	GetMetaData string `protobuf:"bytes,1,opt,name=GetMetaData,proto3" json:"GetMetaData,omitempty"`
}

func (x *API_End_Points) Reset() {
	*x = API_End_Points{}
	if protoimpl.UnsafeEnabled {
...
func (x *API_End_Points) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*API_End_Points) ProtoMessage() {}

func (x *API_End_Points) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use API_End_Points.ProtoReflect.Descriptor instead.
func (*API_End_Points) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{0, 0}
}

func (x *API_End_Points) GetGetMetaData() string {
	if x != nil {
...
var file_proto_types_proto_rawDesc = []byte{
	...
	,
}
...
var file_proto_types_proto_goTypes = []interface{}{
	(*API)(nil),            // 0: main.API
	(*AppMeta)(nil),        // 1: main.AppMeta
	(*API_End_Points)(nil), // 2: main.API.End_Points
}
var file_proto_types_proto_depIdxs = []int32{
	2, // 0: main.API.EndPoints:type_name -> main.API.End_Points
